...
Int_t trdclass_cern24::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t trdclass_cern24::LoadTree(Long64_t entry)
{
...
void trdclass_cern24::Init(TTree *tree)
{
...
void trdclass_cern24::Show(Long64_t entry)
{
...
Int_t trdclass_cern24::Cut(Long64_t entry)
{
...
void trdclass_cern24::Count(const char *tit, double cut1) {
  char clab[20];
  sprintf(clab,"%s_%.1f",tit,cut1);
  hcount->Fill(clab,1);
}
void  trdclass_cern24::Count(const char *tit, double cut1, double cut2) {
  char clab[20];
...
#endif // #ifdef trdclass_cern24_cxx
